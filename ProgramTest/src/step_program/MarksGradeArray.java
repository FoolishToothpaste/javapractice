/**A program to input marks and 3 subjects physics, chemistry and maths and compute the percentage and calculate the grade of several students*/
package step_program;
import java.util.*; //Importing java.util.* for Scanner class

public class MarksGradeArray 
{
	public static void main(String args[])
	{
		...
		int physics[] = new int[number]; //Initializing the array to store the physics marks of the students
		int chemistry[] = new int[number]; //Initializing the array to store the chemistry marks of the students
		int maths[] = new int[number]; //Initializing the array to store the maths marks of the students
		...
		for(int i = 0; i < number; i++) //For Loop
		{
			...
			physics[i] = sc.nextInt(); //Inputting the physics marks of the student
			chemistry[i] = sc.nextInt(); //Inputting the chemistry marks of the student
			maths[i] = sc.nextInt(); //Inputting the maths marks of the student
			
			percentage[i] = (physics[i] + chemistry[i] + maths[i]) / 3.0; //Calculating the percentage of marks of the student
